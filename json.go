...
// WriteJSON writes the JSON encoding of in to the named file.
// If the file does not exist, WriteJSON creates it with permissions 0666.
// However, if the file already exist then WriteJSON will truncate it before
...
// ReadJSON reads the specified file and parses the data and
